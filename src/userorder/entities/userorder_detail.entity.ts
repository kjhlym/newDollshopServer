...
export class Userorder_detail extends BaseEntity {
  ...
  @Column('int', { name: 'order_detail_number' }) order_detail_number;
  @Column('int', { name: 'order_number' }) order_number;
  @Column('int', { name: 'product_number' }) product_number;
  @Column('int', { name: 'product_count' }) product_count;
  @Column('int', { name: 'product_price' }) product_price;
  ...
  @ManyToOne((type) => User_order, (user_order) => user_order.userorder_detail)
